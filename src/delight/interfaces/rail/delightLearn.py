...
def delightLearnh5(configfilename):
    """
    ...
    loc = - 1
    crossValidate = params['training_crossValidate']
    trainingDataIter1 = getDataFromFileh5(params, firstLine, lastLine,prefix="training_", getXY=True,CV=crossValidate)
