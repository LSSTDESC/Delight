...
templates_path = []
exclude_patterns = ["_build", "**.ipynb_checkpoints","Thumbs.db", ".DS_Store","*.pyx"]
...
latex_documents = [
    (master_doc, "delight.tex", "delight Documentation", "Boris Leistedt, David Hogg", "manual"),
]
...
man_pages = [(master_doc, "delight", "delight Documentation", [author], 1)]
